...
class TestAuthenticationRequirements:
    ...
    def test_list_requires_authentication(self):
        CatalogItemFactory.create(sku="AUTH-001")
        client = APIClient()
    ...
    def test_update_requires_authentication(self):
        collectible = CatalogItemFactory.create(sku="AUTH-003")
        client = APIClient()
        
        resp = client.patch(f"/api/v1/catalog/items/{collectible.pk}/", {"name": "Hacked"}, format="json")
        assert resp.status_code == 401

    @pytest.mark.django_db
    def test_delete_requires_authentication(self):
        collectible = CatalogItemFactory.create(sku="AUTH-004")
        client = APIClient()
        
        resp = client.delete(f"/api/v1/catalog/items/{collectible.pk}/")
        assert resp.status_code == 401
...
class TestVendorIsolation:
    ...
    def test_users_only_see_own_vendor_items(self):
        ...
        attach_vendor_profile(user1, vendor1)
        
        CatalogItemFactory.create(vendor=vendor1, sku="V1-ITEM")
        CatalogItemFactory.create(vendor=vendor2, sku="V2-ITEM")
    ...
    def test_cross_vendor_update_blocked(self):
        ...
        item = CatalogItemFactory.create(vendor=vendor2, sku="OTHER-001", name="Original")
        
        client = APIClient()
        client.force_authenticate(user=user1)
        
        resp = client.patch(
            f"/api/v1/catalog/items/{item.pk}/",
            {"name": "Hacked"},
            format="json"
        )
    ...
    def test_cross_vendor_delete_blocked(self):
        ...
        item = CatalogItemFactory.create(vendor=vendor2, sku="OTHER-002")
        
        client = APIClient()
        client.force_authenticate(user=user1)
        
        resp = client.delete(f"/api/v1/catalog/items/{item.pk}/")
        assert resp.status_code == 404
...
class TestInputValidation:
    ...
    def test_sku_uniqueness_enforced(self):
        CatalogItemFactory.create(sku="DUP-001")
    ...
    def test_decimal_prices_accepted(self):
        ...
        item = CatalogItem.objects.get(sku="PRICE-001")
...
class TestStatusCodes:
    ...
    def test_update_returns_200(self):
        ...
        item = CatalogItemFactory.create(vendor=vendor, user=user, sku="UPD-200", store=store)
    ...
    def test_delete_returns_204(self):
        ...
        item = CatalogItemFactory.create(vendor=vendor, user=user, sku="DEL-204", store=store)
    ...
    def test_nonexistent_item_returns_404(self):
        ...
        resp = client.get("/api/v1/catalog/items/999999/")
        assert resp.status_code == 404
