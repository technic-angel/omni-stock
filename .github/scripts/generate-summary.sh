...
SUMMARY_TITLE="### 🧪 Omni-Stock CI Report 🧪"
...
# --- Backend Summary ---
BACKEND_SUMMARY="<details open><summary><strong>🚀 Backend Results (Pytest)</strong></summary>\n\n"
...
for report in $(find "$ARTIFACTS_DIR" -name "pytest-report-*.xml" 2>/dev/null || true); do
  ...
  BACKEND_SUMMARY+="| Total Tests | Passed ✅ | Failed ❌ | Errors ❗ | Skipped ⏭️ | Coverage 📊 |\n"
  BACKEND_SUMMARY+="| :---: | :---: | :---: | :---: | :---: | :---: |\n"
...
# --- Frontend Summary ---
FRONTEND_SUMMARY="<details open><summary><strong>🎨 Frontend Results (Vitest)</strong></summary>\n\n"
...
if [ -f "$FRONTEND_REPORT" ]; then
  ...
  FRONTEND_SUMMARY+="| Code Coverage 📊 | **${FRONTEND_COVERAGE}** |\n"
else
...
DEPLOYMENT_SUMMARY="<details><summary><strong>🌐 Deployment Previews</strong></summary>\n\n"
if [ -n "${PREVIEW_URL-}" ]; then
    DEPLOYMENT_SUMMARY+="🚀 **Frontend Preview:** [${PREVIEW_URL}](${PREVIEW_URL})\n"
...
# --- Artifacts Section ---
ARTIFACTS_SUMMARY="<details><summary><strong>🗂️ Downloadable Artifacts</strong></summary>\n\n"
